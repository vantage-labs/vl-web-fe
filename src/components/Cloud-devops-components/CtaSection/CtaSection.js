...
const CtaSection = (props) => {
  ...
  return (
    <section
      ...
      style={{ backgroundColor: "#212877", backgroundImage: `url(${Bg})` }}
    >
          ...
          <Fade direction="up" triggerOnce={"false"} duration={1000} delay={9}>
            <div>
              <h2 className="title wow fadeInUp" data-wow-duration="600ms">
                Improve your development efficiency with managed Cloud and
                DevOps services
              </h2>
            </div>
          </Fade>
      ...
      <div className="cd-team-member pos-rel">
        <Fade direction="up" triggerOnce={"false"} duration={1000} delay={9}>
          <div>
            <div
              className="xb-img wow fadeInUp"
              data-wow-delay="200ms"
              data-wow-duration="600ms"
            >
              <img src={cta1} alt="Vntage Labs Asset" />
            </div>
          </div>
        </Fade>
        <div className="xb-shape">
          <img className="xbzoominzoomup" src={cta2} alt="Vntage Labs Asset" />
        </div>
