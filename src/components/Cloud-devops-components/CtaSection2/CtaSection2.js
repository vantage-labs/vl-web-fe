...
const CtaSection2 = (props) => {
  ...
  return (
    <section
      className="cta cta-height pos-rel z-1 pt-165"
    ...
    >
        ...
        <div className="row align-items-end">
          <div className="col-12">
            ...
            <div className="cta-image">
              <img src={ctShape} alt="Vntage Labs Asset" />
            </div>
            <div className="cd-cta">
              ...
              <div
                className="xb-btn mt-20 text-center wow fadeInUp"
      ...
      <div className="cd-sec-shape">
        <div className="shape shape--two">
          <img src="assets/img/shape/cta_shape2.png" alt="Vntage Labs Asset" />
        </div>
        <div className="shape shape--three">
          <img src="assets/img/shape/cta_shape1.png" alt="Vntage Labs Asset" />
        </div>
      </div>
    </section>
  );
