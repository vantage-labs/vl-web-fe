      ...
      <div className="container">
        <div className="cd-feature text-center pos-rel">
          <Fade direction="up" triggerOnce={"false"} duration={1000} delay={9}>
            <div>
              <h2 className="title wow skewIn" data-wow-duration="600ms">
                Easily deploy your app in the cloud using modern and efficient
                tech stack
              </h2>
            </div>
          </Fade>
          <Fade direction="up" triggerOnce={"false"} duration={1000} delay={9}>
            <div>
              <div
                className="xb-btn-wrapper text-center mt-50 wow fadeInUp"
                data-wow-duration="600ms"
              >
                <Link
                  onClick={ClickHandler}
                  to="/contact"
                  className="xb-hover-btn xb-btn-item xb-btn-circle xb-element-parallax"
                >
          ...
          <div className="xb-shape">
            <div
              className="shape shape--one wow zoomIn"
              data-wow-duration="600ms"
            >
            ...
            <div
              className="shape shape--two wow zoomIn"
