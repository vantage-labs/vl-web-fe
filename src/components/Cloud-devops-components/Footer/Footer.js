              ...
              <div className="col-lg-6">
                <div className="cd-newslatter text-center">
                  ...
                  <p className="xb-item--content">
                    Subscribe our newsletter for the future updates and insights
                  </p>
                  <form
          ...
          <div className="footer-inner mt-120 ul_li_between mt-none-30">
            <div className="footer-widget mt-30">
              ...
              <p className="xb-content">
                ...
                enterprises with digital transformation. Our team has advanced
                skills and experience in developing large-scale solutions.
              </p>
            </div>
      ...
      <div className="footer-bottom pos-rel o-hidden">
        ...
        >
          <Marquee speed={50} gradient={false}>
            Book a free consultation Book a free consultation Book a free
            consultation Book a free consultation
          </Marquee>
        </Link>
        <Link onClick={ClickHandler} to="/contact" className="footer-btn">
