        ...
        <div className="cd-fanfact-wrapper">
          <div className="sec-title--five white-sec-title text-center mb-80">
            ...
            >
              <div>
                ...
                >
                  Use our cloud DevOps consulting services to get the most value
                  out of your cloud infrastructure and DevOps initiatives.
                </p>
              </div>
            </Fade>
          </div>
          <div className="cd-fanfact-inner ul_li_between mt-none-30">
            <div className="xb-item--item_box mt-30">
              ...
              <span className="xb-item--content">
                of businesses that <br /> adopt cloud reduced <br /> computing
                costs
              </span>
            </div>
            <div className="xb-item--item_box mt-30">
              <h3 className="xb-item--number xb-odm">
                <span className="xbo" data-count="58">
                  <CountUp end={58} enableScrollSpy />
                </span>
                <span className="suffix">%</span>
              </h3>
              <span className="xb-item--content">
                increase in team productivity noted among organizations adopting
                DevOps
              </span>
            </div>
            <div className="xb-item--item_box mt-30">
              <h3 className="xb-item--number xb-odm">
                <span className="xbo" data-count="30">
                  <CountUp end={30} enableScrollSpy />
                </span>
                <span className="suffix">%</span>
              </h3>
              <span className="xb-item--content">
                faster recovery from failures reported by companies implementing
                DevOps practices
              </span>
            </div>
          </div>
          ...
          >
            <Link
              ...
              to="/contact"
              className="thm-btn thm-btn--devops thm-btn--devops_yellow"
            >
