    ...
    <section className="service pos-rel z-1 pt-160 pb-150">
      <div className="container">
            ...
            <div className="sec-title--five text-center mb-35">
              ...
              >
                <div>
                  ...
                  >
                    Use our cloud DevOps consulting services to get the most
                    value out of your cloud infrastructure and DevOps
                    initiatives.
                  </p>
                </div>
              </Fade>
        ...
        <Fade direction="up" triggerOnce={"false"} duration={1200} delay={9}>
          <div>
            <div
              className="xb-btn mt-70 text-center wow fadeInUp"
              data-wow-duration="600ms"
            >
              <Link
                onClick={ClickHandler}
      ...
      <div className="cd-sec-shape">
        <div className="shape shape--one">
          <img src={simg} alt="Vntage Labs Asset" />
        </div>
        <div className="shape shape--four">
          <img src={simg2} alt="Vntage Labs Asset" />
        </div>
      </div>
    </section>
  );
