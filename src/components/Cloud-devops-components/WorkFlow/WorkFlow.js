                ...
                <div className="xb-item--inner">
                  <div className="xb-item--holder">
                    ...
                    <p className="xb-item--content">
                      We gather requirements and design a system that optimizes
                      resources, ensures reliability, and meets your project’s
                      needs.
                    </p>
                  </div>
                  <div className="xb-item--img">
                    <img src={wImg1} alt="Vntage Labs Asset" />
                  </div>
                </div>
              ...
              <div className="cd-work-item">
                <div className="xb-item--inner">
                  <div className="xb-item--holder">
                    ...
                    <p className="xb-item--content">
                      We offer a transparent cost estimate based on the
                      project’s scope, complexity, and timeline for approval.
                    </p>
                  </div>
                  <div className="xb-item--img">
                    <img src={wImg2} alt="Vntage Labs Asset" />
                  </div>
                </div>
              ...
              <div className="cd-work-item">
                <div className="xb-item--inner">
                  <div className="xb-item--holder">
                    ...
                    <p className="xb-item--content">
                      We automate cloud resource setup and configure CI/CD
                      pipelines for fast, error-free deployments.
                    </p>
                  </div>
                  <div className="xb-item--img">
                    <img src={wImg3} alt="Vntage Labs Asset" />
                  </div>
                </div>
              ...
              <div className="cd-work-item">
                <div className="xb-item--inner">
                  <div className="xb-item--holder">
                    ...
                    <p className="xb-item--content">
                      Post-launch, we handle bug fixes, optimizations, and
                      updates to keep your cloud environment running smoothly.
                    </p>
                  </div>
                  <div className="xb-item--img">
                    <img src={wImg4} alt="Vntage Labs Asset" />
                  </div>
                </div>
