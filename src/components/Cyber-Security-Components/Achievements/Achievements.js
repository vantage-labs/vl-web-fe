        ...
        <div className="xb-award-wrap">
          <div className="award-top ul_li_between align-items-end mb-10">
            ...
            <p className="content mb-30">
              We’re proud of the awards we’ve earned, reflecting our dedication
              to delivering top-notch cybersecurity solutions and the trust our
              clients place in us.
            </p>
          </div>
          <div className="row">
            {Award.map((award, i) => (
              <div className="col-lg-3" key={i}>
                ...
                >
                  <div>
                    <div
                      className="award-item wow fadeInUp"
                      data-wow-delay="000ms"
                      data-wow-duration="600ms"
                    >
                      <div className="xb-img">
                        <img src={award.icon} alt="Vntage Labs Asset" />
                      </div>
