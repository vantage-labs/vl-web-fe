  ...
  return (
    <section className="blog pt-155">
      <div className="container">
        ...
        <div className="row justify-content-center mt-none-30">
          {blogs.slice(6, 9).map((blog, Bitem) => (
            <div className="col-lg-4 col-md-6 mt-30" key={Bitem}>
              <div
                className="xb-blog-item wow fadeInUp"
                data-wow-delay="0ms"
                data-wow-duration="600ms"
              >
                <div className="xb-item--holder">
                  ...
                  >
                    ...
                    <div className="xb-item--circle-arrow">
                      <img src={bicon1} alt="Vntage Labs Asset" />
                    </div>
                    <div className="xb-item--line">
                      <img src={bicon2} alt="Vntage Labs Asset" />
                    </div>
                  </Link>
                </div>
                ...
                <ul className="xb-item--meta list-unstyled ul_li">
                  <li>
                    <span>
                      <img src={bicon3} alt="Vntage Labs Asset" />
                    </span>
                    Posted By Johnson
                  </li>
                  <li>
                    <span>
                      <img src={bicon4} alt="Vntage Labs Asset" />
                    </span>
                    {blog.create_at}
                  </li>
                </ul>
        ...
        <div
          className="xb-btn mt-60 text-center wow fadeInUp"
        ...
        >
          <Link
            onClick={ClickHandler}
            to="/blog"
            className="blc-btn blc-btn--gardiant"
          >
            <span>
