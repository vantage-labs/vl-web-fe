        ...
        >
          ...
          <div className="row align-items-center">
            <div className="col-lg-4 mt-30 d-inline-flex justify-content-center">
              <div
                className="xb-work-item pos-rel wow fadeInLeft"
              ...
              >
                ...
                <div className="xb-item--content">
                  <div className="xb-item--line">
                    <img src={dash} alt="Vntage Labs Asset" />
                  </div>
                  <span className="xb-item--number">01</span>
                </div>
                <div className="xb-item--arrow">
                  <img src={arrow} alt="Vntage Labs Asset" />
                </div>
              </div>
            </div>
            <div className="col-lg-4 mt-30 d-inline-flex justify-content-center">
            ...
            <div className="col-lg-4 mt-30 d-inline-flex justify-content-center">
              <div
                className="xb-work-item pos-rel wow fadeInRight"
                data-wow-delay="150ms"
                data-wow-duration="600ms"
              >
                <div className="xb-item--ineer">
