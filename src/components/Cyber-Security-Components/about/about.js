          ...
          <div className="row mt-none-60">
                  ...
                  >
                    <div>
                      ...
                      >
                        ...
                        us a reliable in safeguarding your digital assets.
                      </p>
                    </div>
                  </Fade>
                </div>
                <div
                  className="xb-btn mt-85 wow fadeInUp"
            ...
            <div className="col-lg-6 mt-60">
              ...
              >
                <div>
                  <div
                    className="cs-about_right wow fadeInRight"
                    data-wow-duration="600ms"
                  >
                    ...
                    <div className="xb-content">
                      ...
                      <div className="xb-item--inner">
                        ...
                        <span className="xb-item--content">
                          Our honest specialist team member
                        </span>
                      </div>
                    </div>
                  </div>
          ...
          <div className="row mt-none-30">
            <div className="col-lg-3 col-md-6 cs-feature-col mt-30">
              <div className="cs-feature-item">
                ...
                <span className="xb-item--content">
                  We catch threats early to keep <br /> your systems safe.
                </span>
              </div>
            </div>
            <div className="col-lg-3 col-md-6 cs-feature-col mt-30">
              <div className="cs-feature-item">
                ...
                <span className="xb-item--content">
                  We respond instantly minimizing <br /> to protect your
                  systems.
                </span>
              </div>
            </div>
            <div className="col-lg-3 col-md-6 cs-feature-col mt-30">
              <div className="cs-feature-item">
                ...
                <span className="xb-item--content">
                  We use AI to enhance and ensuring detection and automate
                  protection.
                </span>
              </div>
            </div>
            <div className="col-lg-3 col-md-6 cs-feature-col mt-30">
              <div className="cs-feature-item">
                ...
                <span className="xb-item--content">
                  We help you meet regulations and manage security risks
                  effectively.
                </span>
              </div>
            </div>
