...
const CtaSection = (props) => {
  ...
  return (
    <section
      className="cta pos-rel pt-130 pb-135"
    ...
    >
          ...
          <div className="col-lg-7">
            <div className="hd-cta text-center">
              ...
              >
                <div>
                  <div
                    className="xb-btn text-center mt-45 wow fadeInUp"
                  ...
                  >
                    <Link
                      ...
                      to="/pricing"
                      className="thm-btn thm-btn--three"
                    >
      ...
      <div className="hd-cta_shape">
        <div>
          <div
            className="shape shape--one wow fadeInLeft"
        ...
        <div>
          <div
            className="shape shape--two wow fadeInRight"
        ...
        <div>
          <div className="shape shape--three">
            <img src={line} alt="Vntage Labs Asset" />
          </div>
        </div>
      </div>
    </section>
