      ...
      <div className="container">
        <div className="fanfact-wrap ul_li_between mt-none-30">
          ...
          >
            <div className="xb-item--holder mb-25 ul_li_between">
              <h2 className="xb-item--number">
                <CountUp end={286} enableScrollSpy />%
              </h2>
              <span>
            ...
            <p className="xb-item--content">
              Average ROI customers have achieved <br /> over a three-year
              period.
            </p>
          </div>
          <div
          ...
          >
            <div className="xb-item--holder mb-25 ul_li_between">
              <h2 className="xb-item--number">
                <CountUp end={10} enableScrollSpy /> Months
              </h2>
              <span>
                <img src={sIcon2} alt="Vntage Labs Asset" />
              </span>
            </div>
            <p className="xb-item--content">
              Time it took for customers to achieve <br /> full payback on their
              investment.
            </p>
          </div>
          <div
          ...
          >
            <div className="xb-item--holder mb-25 ul_li_between">
              <h2 className="xb-item--number">
                $<CountUp end={20} enableScrollSpy />M
              </h2>
              <span>
                <img src={sIcon3} alt="Vntage Labs Asset" />
              </span>
            </div>
            <p className="xb-item--content">
