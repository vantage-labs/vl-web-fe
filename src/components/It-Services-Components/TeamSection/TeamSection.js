      ...
      <div className="container">
        <div className="team-heading text-center pos-rel">
          ...
          <ul className="team-member list-unstyled">
            ...
            >
              <div>
                <img src={tImg3} alt="Vntage Labs Asset" />
              </div>
            </li>
            <li
            ...
            >
              <div>
                <img src={tImg4} alt="Vntage Labs Asset" />
              </div>
            </li>
            <li
            ...
            >
              <div>
                <img src={tImg5} alt="Vntage Labs Asset" />
              </div>
            </li>
            <li
            ...
            >
              <div>
                <img src={tImg6} alt="Vntage Labs Asset" />
              </div>
            </li>
            <li
            ...
            >
              <div>
                <img src={tImg7} alt="Vntage Labs Asset" />
              </div>
            </li>
          </ul>
        </div>
