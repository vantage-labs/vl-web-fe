              ...
              <div className="testimonial-item">
                <div className="xb-item--holder">
                  <div className="xb-item--author">
                    <div className="img img--one">
                      <img src={item.tIcon} alt="Vntage Labs Asset" />
                    </div>
                    <div className="img img--two">
                      <img src={item.tImg} alt="Vntage Labs Asset" />
                    </div>
                ...
                <div className="xb-item--bottom ul_li_between">
                  <div className="xb-item--rating">
                    <span>
                      <img src={ticon1} alt="Vntage Labs Asset" /> 5.0
                    </span>
                  </div>
                  <span className="xb-item--quat">
                    <img src={ticon2} alt="Vntage Labs Asset" />
                  </span>
                </div>
              </div>
            </SwiperSlide>
