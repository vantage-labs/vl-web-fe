                            ...
                            <div className="about-left">
                                ...
                                <div className="about-item_box ul_li">
                                    ...
                                    <div className="xb-item--holder">
                                        <p className="xb-item--content"><span>{t("about.coreValues.0.headline")}:</span> {t("about.coreValues.0.label")}</p>
                                    </div>
                                </div>
                                <div className="about-item_box ul_li">
                                    <div className="xb-item--icon"><img src={about2} alt="" /></div>
                                    <div className="xb-item--holder">
                                        <p className="xb-item--content"><span>{t("about.coreValues.1.headline")}:</span> {t("about.coreValues.1.label")}</p>
                                    </div>
                                </div>
                                <div className="about-item_box ul_li">
                                    ...
                                    <div className="xb-item--holder">
                                        <p className="xb-item--content"><span>{t("about.coreValues.2.headline")}:</span> {t("about.coreValues.2.label")}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
