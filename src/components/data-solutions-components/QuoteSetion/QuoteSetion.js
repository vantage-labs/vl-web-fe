          ...
          <div className="da-quote">
            <div className="xb-item--inner">
              <span className="xb-item--quote">
                <img src={qImg1} alt="Vntage Labs Asset" />
              </span>
              <p className="xb-item--content">
                “Data and AI is not only about finding answers faster – but
                creating transparency around issues that have always been murky”
              </p>
              <div className="xb-item--holder ul_li">
                <div className="xb-item--author">
                  <img src={qImg2} alt="Vntage Labs Asset" />
                </div>
                <div className="xb-item--avatar">
                  ...
                  <div className="xb-item--brand">
                    <img src={qImg3} alt="Vntage Labs Asset" />
                  </div>
                </div>
              </div>
            </div>
