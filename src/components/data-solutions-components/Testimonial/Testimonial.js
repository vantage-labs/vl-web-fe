      ...
      <div className="container">
        <div className="da-sec-titlte text-center mb-60">
          <span className="sub_title">
            <span>
              <img src={ticon1} alt="Vntage Labs Asset" />
            </span>
            Case studies
          </span>
                    ...
                    <div className="col-lg-6 mt-30">
                      <div className="da-tes-left">
                        <h2 className="xb-item--title">
                          Transforming a leading medical imaging service
                          provider with Microsoft Cloud
                        </h2>
                        <p className="xb-item--content content--one">
                          With the ambition to scale and further develop its
                          AI-imaging biomarker service offering to the global
                          clinical trial market, IXICO came to us for a secure
                          and seamless cloud transformation.
                        </p>
                        <div className="xb-item--holder ul_li align-items-start">
                          <div className="xb-item--meta">
                            ...
                            <span className="xb-item--text">
                              Annual cost savings achieved through optimized
                              trial operations.
                            </span>
                          </div>
                          <div className="xb-item--meta">
                            ...
                            <span className="xb-item--text">
                              Supported globally with IXICO's AI-enhanced
                              imaging biomarkers.
                            </span>
                          </div>
                        </div>
                        <p className="xb-item--content content--two">
                          IXICO is a premium, specialist neuroimaging services
                          provider to the global biopharmaceutical industry.
                        </p>
                        <p className="xb-item--content content--three">
                          The company develops and deploys therapeutic specific
                          AI <br /> (Artificial Intelligence) algorithms
                          designed to reduce clinical trial <br /> size and
                          costs whilst simultaneously improving insights to
                          increase the likelihood of approval in neurological
                          clinical trials.
                        </p>
                      </div>
                    </div>
                    <div className="col-lg-6 mt-30">
                      <div className="da-tes-right">
                        <div className="xb-item--author">
                          <img src={tImg1} alt="Vntage Labs Asset" />
                        </div>
                        <div className="xb-item--avatar">
                          <img src={tImg2} alt="Vntage Labs Asset" />
                        </div>
                      </div>
                    </div>
                  </div>
