  ...
  return (
    ...
    <div id="xb-header-area" className="header-area header-style-two header-transparent">
      <div className="header-top">
        <span>  Enjoy 15% off on all annual plans until April 2025! Elevate your brand
          with Vantage Labs' cutting-edge digital solutions 🚀"</span>
                                          ...
                                          <ul
                                            ...
                                            <li>
                                              <Link onClick={ClickHandler}
                                                ...
                                                <span
                                                  className="icon_list_text">Web Development</span>
                                              </Link>
                                            </li>
                                            <li>
                                              <Link onClick={ClickHandler}
                                                ...
                                                <span
                                                  className="icon_list_text">Web Design UI</span>
                                              </Link>
                                            </li>
                                          </ul>
                                        </div>
                                          ...
                                          <ul
                                            ...
                                            <li>
                                              <Link onClick={ClickHandler}
                                                ...
                                                <span
                                                  className="icon_list_text">Ui / UX </span>
                                              </Link>
                                            </li>
                                            <li>
                                              <Link onClick={ClickHandler}
                                                ...
                                                <span
                                                  className="icon_list_text">Marketing Digital Package</span>
                                              </Link>
                                            </li>
                                          </ul>
                                        </div>
