...
const Header = (props) => {
  ...
  return (
    <div
      id="xb-header-area"
      className="header-area header-style-two header-style-four header-transparent"
    >
                    ...
                    <ul className="submenu">
                      ...
                      <li>
                        <NavLink
                          ...
                          to="/blog-single/AI-in-Neuroimaging-IXICOs-Cloud-Transformation"
                        >
                ...
                >
                  <div className="xb-header-menu-scroll lenis lenis-smooth">
                    ...
                    <div className="xb-logo-mobile xb-hide-xl">
                      <NavLink onClick={ClickHandler} to="/" rel="home">
                        <img src={logo} alt="Vntage Labs Asset" />
                      </NavLink>
                    </div>
