          ...
          <div className="row align-items-center mt-none-30">
                  ...
                  <div>
                    ...
                    >
                      <Link
                        ...
                        className="thm-btn thm-btn--devops"
                      >
            ...
            <div className="col-lg-5 mt-30">
              ...
              >
                <div>
                  <div
                    className="hero-right_img  wow fadeInRight"
          ...
          <Marquee speed={50} gradient={false}>
            <div className="cd-brand-item">
              ...
              <h3 className="xb-item--title">
                Top Rated Cloud & DevOps Service Provider{" "}
            ...
            <div className="cd-brand-item">
              ...
              <h3 className="xb-item--title">
                <span>Partner -</span> "Certified AWS Partner for Cloud
                Solutions<span>(5.0 Rating)</span>
              </h3>
            </div>
            <div className="cd-brand-item">
              <div className="xb-item--img">
              ...
              <h3 className="xb-item--title">
                Highly Recommended Cloud Solutions with Excellent Reviews{" "}
                <span>(4.89 Rating)</span>
              </h3>
            </div>
          </Marquee>
        </div>
