              ...
              <div className="container">
                ...
                <div className="row">
                  <div className="col-lg-12">
                    <div
                      className="xb-faq cp-faq wow fadeInUp"
                      ...
                      >
                        <AccordionItem className="block">
                          ...
                          <AccordionBody accordionId="1" className="acc_body">
                            <div className="content">
                              <p>
                                Apply for a position by sending us your CV or
                                providing a link to your LinkedIn profile, and
                        ...
                        <AccordionItem className="block">
                          <AccordionHeader targetId="2" className="acc-btn">
                            <span className="number">02</span> _Initial
                            screening results?
                            <span className="arrow"></span>
                          </AccordionHeader>
                          <AccordionBody accordionId="2" className="acc_body">
                            <div className="content">
                              <p>
                                Our recruiter will get back to you if your
                                resume meets our requirements in order to
                                introduce you to the role.
                              </p>
                            </div>
                          </AccordionBody>
                        </AccordionItem>
                        <AccordionItem className="block">
                          ...
                          <AccordionBody accordionId="3" className="acc_body">
                            <div className="content">
                              <p>
                                You will meet a few of your potential colleagues
                                to talk about your skills, background, and
                        ...
                        <AccordionItem className="block">
                          ...
                          <AccordionBody accordionId="4" className="acc_body">
                            <div className="content">
                              <p>
                                If needed, we’ll arrange a small test task.
                                Depending on the project and role, this may be
                                followed by a client interview.
                              </p>
                            </div>
                          </AccordionBody>
                        </AccordionItem>
