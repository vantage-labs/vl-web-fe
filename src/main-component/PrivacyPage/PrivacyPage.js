              ...
              <div className="row">
                <div className="col-lg-11">
                  <div className="item-details-widget">
                    ...
                    <p>
                      Certain types of data may be necessary to access and
                      utilize specific features or services on this website. For
                      example, contact information, account details, or
                      preferences may be required to personalize the experience
                      or enable specific functionalities
                    </p>
                  </div>
                  <div className="item-details-widget">
                    <h2 className="item_details_info_title">
                  ...
                  <div className="item-details-widget">
                    ...
                    <ul className="privacy-details">
                      ...
                      <li>
                        Request the deletion of their data when it's no longer
                        needed.
                      </li>
                      <li>Request their data in a transferable format.</li>
                      <li>
                        Limit the processing of their data in certain
                        situations.
                      </li>
                      <li>
                        Object to the processing of their data for direct
                        marketing or legitimate interests.
                      </li>
                      <li>Withdraw consent for data processing at any time.</li>
                      <li>
                        File a complaint with a supervisory authority if they
                  ...
                  <div className="item-details-widget">
                    ...
                    <p>
                      ...
                      targeted advertising through the Network Advertising
                      Initiative.
                    </p>
                  </div>
                  <div className="item-details-widget">
